...
class TestUtils(unittest.TestCase):
    ...
    def test_resolve_dns_supports_dnspython_v1(self):
        with (unittest.mock.patch.object(utils.dns.version, "MAJOR", 1),
              unittest.mock.patch.object(utils.dns.resolver, "query") as query_mocks):
    ...
    def test_resolve_dns_supports_dnspython_v2(self):
        with (unittest.mock.patch.object(utils.dns.version, "MAJOR", 2),
              unittest.mock.patch.object(utils.dns.resolver, "resolve") as resolve_mocks):
            utils.resolve_dns("example.com", "any", other="parameter")
